...
import { Home, MessageSquare, Map, Trophy, Users, Bell, UserCircle, Umbrella } from 'lucide-react'
...
export default function AppSidebar({ timeOffEnabled = false }: AppSidebarProps) {
  const pathname = usePathname()

  const navItems = timeOffEnabled
    ? [...BASE_NAV_ITEMS, { href: '/app/tiempo', icon: Umbrella, label: 'Tiempo libre' }]
    : BASE_NAV_ITEMS
